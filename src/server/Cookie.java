...
public class Cookie<V> {
  ...
  public static Map<String, String> parse(String cookieString) {
    return UrlEncodedUtils.parseUrlEncoded(cookieString, ";");
  }
  ...
  public String toString() {
    ...
    if(getMaxAge() != null) sb.append(String.format("; Max-Age=%s", getMaxAge()));
    if(isHttpOnly()) sb.append(String.format("; HttpOnly"));
